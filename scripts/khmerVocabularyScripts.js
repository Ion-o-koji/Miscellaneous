    (function() {
      ...
      if (lastVersion !== CURRENT_VERSION) {
        ...
        window._kvUpdateAvailable = CURRENT_VERSION;
      }
    })();
...
<div id="fs-overlay" onclick="enterFsFromOverlay()">
    ...
    <div class="mcard" style="max-width:520px">
      ...
      <div class="cfg-section">
        ...
        <div class="cfg-row">
          ...
          <span style="font-size:.72rem;color:var(--dim)">v8.6.4</span>
        </div>
        <div class="cfg-row">
          <div class="cfg-row-left">
  ...
  `;
    ...
    function init() {
      if (window._kvUpdateAvailable) showUpdateBanner(window._kvUpdateAvailable);
      checkStreakReset();
      updateStudyStreak();
      loadSettings();
      refreshAllCatDropdowns();
    ...
    _kvOnReady(function() {
      ...
      (() => {
        const ENTRY = 'Khmer Vocabulary v8.6.4',
