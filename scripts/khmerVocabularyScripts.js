      ...
      <div class="cfg-section">
        ...
        <div class="cfg-row">
          <div class="cfg-row-left">
            ...
            <div class="cr-sub">
              1. <a href="https://docs.google.com/document/d/1ynpcFYYxTFDjj9exho4jvJZeWI55VQJDmJutVzQgH30/edit?usp=drivesdk" style="text-decoration:underline;color:#6b9bd1">KV CHANGELOG</a><br>
              2. <a href="https://docs.google.com/document/d/1s1HbAuR1h9jH_MAjnk0gMCkzKoHNU9Sa1DiXR61RpgU/edit?usp=drivesdk" style="text-decoration:underline;color:#6b9bd1">KV FEATURE REQUESTS & BUG REPORTS</a>
            </div>
          </div>
          <span style="font-size:.72rem;color:var(--dim)">External <br>Docs</span>
        </div>
        <div class="cfg-row">
          <div class="cfg-row-left">
          ...
          <span style="font-size:.72rem;color:var(--dim)">v8.1</span>
        </div>
        <div class="cfg-row">
          <div class="cfg-row-left">
